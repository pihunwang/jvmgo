...
func newConstantInfo(tag uint8, cp ConstantPool) ConstantInfo {
	...
	case CONSTANT_Fieldref:return &ConstantMemberrefInfo{cp: cp}
	case CONSTANT_Methodref:return &ConstantMemberrefInfo{cp: cp}
	case CONSTANT_InterfaceMethodref:return &ConstantMemberrefInfo{cp: cp}
